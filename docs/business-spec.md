...
|----------|----------|----------------|------------------|
| BR-USER-001 | シミュレーション生成 | 可能 | 可能 |
| BR-USER-002 | シミュレーション保存 | 不可 | 可能 |
| BR-USER-003 | 共有URL生成 | 不可 | 可能 |
| BR-USER-004 | 履歴閲覧 | 不可 | 可能 |
| BR-USER-005 | APIレート制限 | 10 requests/min | 30 requests/min |
