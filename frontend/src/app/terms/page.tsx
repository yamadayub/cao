      ...
      <main className="flex-1 pt-20">
        <div className="container-narrow py-8 md:py-12">
          ...
          <div className="text-center mb-8 md:mb-12">
            <p className="text-xs tracking-[0.2em] text-primary-600 uppercase mb-3">Terms of Service</p>
          ...
          <article className="bg-white rounded-2xl shadow-elegant p-6 md:p-8">
            <div className="prose prose-neutral max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">第1条（適用）</h2>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">第2条（定義）</h2>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">第3条（サービスの内容）</h2>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">第4条（利用登録）</h2>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">第5条（アップロード画像について）</h2>
                <ol className="list-decimal pl-6 text-neutral-700 space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">第6条（禁止事項）</h2>
                <p className="text-neutral-700 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">第7条（免責事項）</h2>
                <ol className="list-decimal pl-6 text-neutral-700 space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">第8条（知的財産権）</h2>
                <p className="text-neutral-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">第9条（個人情報の取り扱い）</h2>
                <p className="text-neutral-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">第10条（規約の変更）</h2>
                <p className="text-neutral-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">第11条（準拠法・管轄裁判所）</h2>
                <p className="text-neutral-700 leading-relaxed">
