      ...
      try {
        ...
        if (err instanceof ApiError) {
          if (err.code === 'NOT_FOUND') {
            setError(t('view.invalidUrl'))
          } else {
            setError(err.localizedMessage)
          }
        } else {
          setError(t('view.fetchError'))
        }
      } finally {
        setIsLoading(false)
      }
        ...
        <div className="container-narrow py-8 md:py-12">
          ...
          {isLoading && (
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-neutral-700 text-base font-serif">{t('view.loading')}</p>
            </div>
          )}
                  ...
                  <div className="aspect-square bg-neutral-100 flex items-center justify-center">
                    {currentImage ? (
                      <img
                        ...
                        alt={t('view.resultAlt', { progress: String(Math.round(currentImage.progress * 100)) })}
