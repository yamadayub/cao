      ...
      <main className="flex-1 pt-20">
        <div className="container-narrow py-8 md:py-12">
          ...
          <div className="text-center mb-8 md:mb-12">
            <p className="text-xs tracking-[0.2em] text-primary-600 uppercase mb-3">Privacy Policy</p>
          ...
          <article className="bg-white rounded-2xl shadow-elegant p-6 md:p-8">
            <div className="prose prose-neutral max-w-none">
              <p className="text-sm text-neutral-500 mb-6">最終更新日: 2025年1月24日</p>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">1. 収集する情報</h2>
                <p className="text-neutral-700 leading-relaxed mb-4">
                  当サービスでは、以下の情報を収集することがあります。
                </p>

                <h3 className="text-lg font-medium text-neutral-800 mb-2">1.1 ユーザーが提供する情報</h3>
                <ul className="list-disc pl-6 text-neutral-700 space-y-2 mb-4">
                  <li>メールアドレス（利用登録時）</li>
                  <li>顔画像（シミュレーション利用時）</li>
                </ul>

                <h3 className="text-lg font-medium text-neutral-800 mb-2">1.2 自動的に収集される情報</h3>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">2. 情報の利用目的</h2>
                <p className="text-neutral-700 leading-relaxed mb-4">
                  収集した情報は、以下の目的で利用します。
                </p>
                <ul className="list-disc pl-6 text-neutral-700 space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">3. 顔画像の取り扱い</h2>
                <p className="text-neutral-700 leading-relaxed mb-4">
                  当サービスでは、顔画像を以下のように取り扱います。
                </p>

                <h3 className="text-lg font-medium text-neutral-800 mb-2">3.1 未登録ユーザーの場合</h3>
                <p className="text-neutral-700 leading-relaxed mb-4">
                  アップロードされた画像は、シミュレーション処理のためにのみ使用され、セッション終了後にサーバーから削除されます。サーバーに永続的に保存されることはありません。
                </p>

                <h3 className="text-lg font-medium text-neutral-800 mb-2">3.2 登録ユーザーの場合</h3>
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">4. 情報の共有</h2>
                <p className="text-neutral-700 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">5. 情報の保護</h2>
                <p className="text-neutral-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">6. Cookieの使用</h2>
                <p className="text-neutral-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">7. ユーザーの権利</h2>
                <p className="text-neutral-700 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">8. 同意状態の保存</h2>
                <p className="text-neutral-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">9. 未成年者の利用</h2>
                <p className="text-neutral-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">10. プライバシーポリシーの変更</h2>
                <p className="text-neutral-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-serif text-neutral-900 mb-4">11. お問い合わせ</h2>
                <p className="text-neutral-700 leading-relaxed">
